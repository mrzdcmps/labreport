...
generate_bfplot(list(
  `DE high` = study11_psyscanner.de.h$BF,
  `DE low` = study11_psyscanner.de.l$BF,
  `AV high` = study11_psyscanner.av.h$BF,
  `AV low` = study11_psyscanner.av.l$BF,
  `OC high` = study11_psyscanner.oc.h$BF,
  `OC low` = study11_psyscanner.oc.l$BF
))
```
...
generate_rwplot(list(
  `DE high` = study11_psyscanner.de.h$de.sum,
  `DE low` = study11_psyscanner.de.l$de.sum,
  `AV high` = study11_psyscanner.av.h$av.sum,
  `AV low` = study11_psyscanner.av.l$av.sum,
  `OC high` = study11_psyscanner.oc.h$oc.sum,
  `OC low` = study11_psyscanner.oc.l$oc.sum
), 30)
...
### DE high
```{r}
generate_coeplot(study11_psyscanner.de.h$BF)
```
### DE low
```{r}
generate_coeplot(study11_psyscanner.de.l$BF)
```
### AV high
```{r}
generate_coeplot(study11_psyscanner.av.h$BF)
```
### AV low
```{r}
generate_coeplot(study11_psyscanner.av.l$BF)
```
### OC high
```{r}
generate_coeplot(study11_psyscanner.oc.h$BF)
```
### OC low
```{r}
generate_coeplot(study11_psyscanner.oc.l$BF)
```
:::
