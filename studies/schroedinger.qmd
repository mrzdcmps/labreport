...
generate_bfplot(list(
  exp = study22_schroedinger$BF.exp,
  con = study22_schroedinger$BF.con
))
```
...
generate_rwplot(list(
  exp = study22_schroedinger$hitsExp,
  con = study22_schroedinger$hitsCon
), 10)
...
### Exp
```{r}
generate_coeplot(study22_schroedinger$BF.exp)
```
### Con
```{r}
generate_coeplot(study22_schroedinger$BF.con)
```
:::
